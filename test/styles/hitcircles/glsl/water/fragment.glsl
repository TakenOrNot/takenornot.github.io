                    ...
                    //const vec3 depthGradientShallow = vec3(1.462, 0.458, 0.192);

                    //const vec3 depthGradientDeep = vec3(0.5, 0.0, 0.0);
                    ...
                    void main(void) {
                        ...
                        */
                        ...
                        // remap frag screen space coords to ndc (-1 to +1)
                            ...
                            baseColor = mix((depthGradientShallow + (diffuseColorClamped)) * .6, (depthGradientDeep + (diffuseColorClamped)) * .6, wdepth);
